...
namespace SchoolManagementSystem {
    ...
    public partial class smsDataSet : global::System.Data.DataSet {
        ...
        public partial class ResultDataTable : global::System.Data.TypedTableBase<ResultRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ResultRow AddResultRow(string sid, string subid, string mark) {
        ...
        public partial class ResultRow : global::System.Data.DataRow {
            ...
            public string subid {
                get {
                    try {
                        return ((string)(this[this.tableResult.subidColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'subid\' in table \'Result\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableResult.subidColumn] = value;
                }
            }
            ...
            public string mark {
                get {
                    try {
                        return ((string)(this[this.tableResult.markColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'mark\' in table \'Result\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IssubidNull() {
                return this.IsNull(this.tableResult.subidColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetsubidNull() {
                this[this.tableResult.subidColumn] = global::System.Convert.DBNull;
            }
...
namespace SchoolManagementSystem.smsDataSetTableAdapters {
    ...
    public partial class ResultTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Result] WHERE (([ResultID] = @Original_ResultID) AND ((@IsNull_sid = 1 AND [sid] IS NULL) OR ([sid] = @Original_sid)) AND ((@IsNull_subid = 1 AND [subid] IS NULL) OR ([subid] = @Original_subid)) AND ((@IsNull_mark = 1 AND [mark] IS NULL) OR ([mark] = @Original_mark)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Result] ([sid], [subid], [mark]) VALUES (@sid, @subid, @mark);" +
                "\r\nSELECT ResultID, sid, subid, mark FROM Result WHERE (ResultID = SCOPE_IDENTITY" +
                "())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Result] SET [sid] = @sid, [subid] = @subid, [mark] = @mark WHERE (([ResultID] = @Original_ResultID) AND ((@IsNull_sid = 1 AND [sid] IS NULL) OR ([sid] = @Original_sid)) AND ((@IsNull_subid = 1 AND [subid] IS NULL) OR ([subid] = @Original_subid)) AND ((@IsNull_mark = 1 AND [mark] IS NULL) OR ([mark] = @Original_mark)));
SELECT ResultID, sid, subid, mark FROM Result WHERE (ResultID = @ResultID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SchoolManagementSystem.Properties.Settings.Default.smsDB;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ResultID, sid, subid, mark FROM dbo.Result";
        ...
        public virtual int Fill(smsDataSet.ResultDataTable dataTable) {
        ...
        public virtual smsDataSet.ResultDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            smsDataSet.ResultDataTable dataTable = new smsDataSet.ResultDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(smsDataSet.ResultDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ResultID, string Original_sid, string Original_subid, string Original_mark) {
            ...
            if ((Original_subid == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((string)(Original_subid));
            }
        ...
        public virtual int Insert(string sid, string subid, string mark) {
            if ((sid == null)) {
        ...
        public virtual int Update(string sid, string subid, string mark, int Original_ResultID, string Original_sid, string Original_subid, string Original_mark, int ResultID) {
            if ((sid == null)) {
            ...
            if ((subid == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[1].Value = ((string)(subid));
            }
            if ((mark == null)) {
            ...
            if ((Original_subid == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_subid));
            }
            if ((Original_mark == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(ResultID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string sid, string subid, string mark, int Original_ResultID, string Original_sid, string Original_subid, string Original_mark) {
            return this.Update(sid, subid, mark, Original_ResultID, Original_sid, Original_subid, Original_mark, Original_ResultID);
        }
    }
